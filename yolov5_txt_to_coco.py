...
coco_format_save_path = '../trt_coco_labels_new/test'  # 要生成的标准coco格式标签所在文件夹
yolo_format_classes_path = './coco_labels/military_object.names'  # 类别文件，一行一个类
yolo_format_annotation_path = './trt_txt/'  # yolo格式标签所在文件夹
img_pathDir = '../datasets/n17_cooling_bed/images/test'  # 图片所在文件夹
...
for i, imageFile in enumerate(imageFileList):
    ...
    txtFile = filename + '.txt'  # 获取该图片获取的txt文件
